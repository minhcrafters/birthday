...
export default function Snoofy({
  isOpen,
  onDismiss,
  onCloseComplete,
}: LetterProps) {
        ...
        >
          ...
          >
            ...
            >
              ...
              <p>
                no need for a paragraph, you alr know the deal. the voice of my
                actions express my gratitude for your existence far better than
                text on a screen. happy birthday shiori
              </p>
              <video
                ref={videoRef}
                ...
                controls
                onPlay={() =>
                  window.dispatchEvent(new CustomEvent("letter-video-play"))
                }
                onPause={() =>
                  window.dispatchEvent(new CustomEvent("letter-video-pause"))
                }
              />
              <br />
              <p>- Snoofy</p>
